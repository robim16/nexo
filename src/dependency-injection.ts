...
container.register(
  'CreatePostUseCase',
  new CreatePostUseCase(postRepository, userRepository, storageService, eventBus)
)
container.register(
  'GetFeedUseCase',
  new GetFeedUseCase(postRepository, followRepository, userRepository)
)
container.register('GetUserPostsUseCase', new GetUserPostsUseCase(postRepository, userRepository))
container.register(
  'LikePostUseCase',
  new LikePostUseCase(postRepository, notificationRepository, followRepository, eventBus)
)
container.register(
  'AddCommentUseCase',
...
container.register(
  'DeletePostUseCase',
  new DeletePostUseCase(postRepository, userRepository, storageService, eventBus)
)
...
container.register(
  'FollowUserUseCase',
  new FollowUserUseCase(followRepository, userRepository, notificationRepository, eventBus)
)
container.register(
  'UnfollowUserUseCase',
  new UnfollowUserUseCase(followRepository, userRepository, eventBus)
)
...
container.register(
  ...
  new GetSuggestedUsersUseCase(userRepository, followRepository)
)

container.register(
  'GetNotificationsUseCase',
  new GetNotificationsUseCase(notificationRepository, userRepository)
)
container.register(
  'MarkNotificationReadUseCase',
  new MarkNotificationReadUseCase(notificationRepository, eventBus)
)
container.register(
  'UpdateUserProfileUseCase',
  new UpdateUserProfileUseCase(userRepository, storageService)
)
